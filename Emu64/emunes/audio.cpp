...
uint8_t audio::length_table[] = { 10, 254, 20,  2, 40,  4, 80,  6,
...
void audio::cpuWrite(uint16_t addr, uint8_t data)
{
	switch (addr)
	{
	case 0x4000:
...
uint8_t audio::cpuRead(uint16_t addr)
{
	uint8_t data = 0x00;
